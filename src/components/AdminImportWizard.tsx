...
export const AdminImportWizard: React.FC<AdminImportWizardProps> = ({
  ...
  // Step 1: Selection
  const [selectedBank, setSelectedBank] = useState<string>('moh_bank');
        ...
        <div className="space-y-5 text-xs">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              >
                <option value="moh_bank">MOH - Ministry of Health Residency Bank</option>
                <option value="jrms_bank" disabled>
                  JRMS - Royal Medical Services (Future)
                </option>
                <option value="khcc_bank" disabled>
                  KHCC - King Hussein Cancer Center (Future)
                </option>
              </select>
          ...
          <div className="p-4 rounded-xl bg-slate-950/60 border border-slate-800 flex items-center justify-between">
            <div>
              ...
              <strong className="text-cyan-400">
                MOH Bank ({selectedYear} Exam Batch)
              </strong>
            </div>
            <button
              onClick={() => setStep(1)}
